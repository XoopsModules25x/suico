...
if (isset($nbSections[NBPHOTOS]) && 0 === $nbSections[NBPHOTOS]) {
    ...
    foreach ($pictures_object_array as $picture) {
        ...
        $pictures_array[$i]['date_creation'] = formatTimeStamp($picture->getVar('data_creation', 's'));
		$pictures_array[$i]['date_update'] = formatTimeStamp($picture->getVar('data_update', 's'));
