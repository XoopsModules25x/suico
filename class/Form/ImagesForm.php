...
class ImagesForm extends XoopsThemeForm
{
    ...
    public function __construct($target)
    {
        ...
        $title              = $this->targetObject->isNew() ? \AM_SUICO_IMAGES_ADD : \AM_SUICO_IMAGES_EDIT;
