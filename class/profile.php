 ...
 * @copyright       (c) 2000-2016 XOOPS Project (www.xoops.org)
 */
class YogurtProfile extends XoopsObject
{
    /**
     * @param $fields
     */
    ...
    /**
     * Initiate variables
     * @param array $fields field information array of {@link XoopsYogurtField} objects
     */
 ...
 * @copyright       (c) 2000-2016 XOOPS Project (www.xoops.org)
 */
class YogurtProfileHandler extends XoopsPersistableObjectHandler
{
    /**
    ...
    {
        parent::__construct($db, 'yogurt_profile', 'yogurtprofile', 'profile_id');
