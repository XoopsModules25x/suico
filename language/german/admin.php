...
define('_MA_YOGURT_FRAMEWORKSTRUE', 'Sie haben Framework-Version %s');
define('_MA_YOGURT_BY', 'Von');
define('_MA_YOGURT_DESC', 'Beschreibung');
define('_MA_YOGURT_CREDITS', 'Credits');
define('_MA_YOGURT_CONTRIBUTORS', 'Information &uuml;ber Mitwirkende');
define('_MA_YOGURT_DEVELOPERS', 'Entwickler');
define('_MA_YOGURT_TESTERS', 'Tester');
define('_MA_YOGURT_TRANSLATIONS', '&Uuml;bersetzungen');
define('_MA_YOGURT_EMAIL', 'eMail');
define('_MA_YOGURT_MODDEVDET', 'Modulentwicklung-Details');
define('_MA_YOGURT_RELEASEDATE', 'Ver&ouml;ffentlichungsdatum');
