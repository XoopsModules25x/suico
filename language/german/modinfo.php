...
define('_MI_YOG_PICTURE_TEMPLATENOTEBOOKDESC', 'Vorlage f&uuml;r das G&auml;stebuch');
...
define('_MI_YOG_NOTE_NOTIFYTIT', 'G&auml;stebuch');
define('_MI_YOG_NOTE_NOTIFYDSC', 'G&auml;stebuch-Benachrichtigungen');
define('_MI_YOG_NOTE_NEWNOTE_NOTIFY', 'Neuer G&auml;stebucheintrag');
define('_MI_YOG_NOTE_NEWNOTE_NOTIFYCAP', 'Benachrichtige mich, wenn ein neuer Eintrag in diesem G&auml;stebuch erstellt wurde');
define('_MI_YOG_NOTE_NEWNOTE_NOTIFYDSC', 'Benachrichtigt den User &uuml;ber neue G&auml;stebucheintr&auml;ge');
define('_MI_YOG_NOTE_NEWNOTE_NOTIFYSBJ', '{X_OWNER_NAME} hat einen Eintrag im G&auml;stebuch erhalten');
...
define('_MI_YOG_ENABLENOTES_TITLE', 'Aktiviere G&auml;stebuch-Sektion');
define('_MI_YOG_ENABLENOTES_DESC', "Das Aktivieren der G&auml;stebuchfunktion erm&ouml;glicht Usern, Nachrichten bei anderen Usern zu hinterlassen. Diese Funktion ist wie die 'Wall' bei Facebook ");
...
define('_MI_YOG_NOTESPERPAGE_TITLE', 'Anzahl G&auml;stebucheintr&auml;ge je Seite');
define('_MI_YOG_NOTESPERPAGE_DESC', 'Anzahl G&auml;stebucheintr&auml;ge, bevor die Seitennavigation angezeigt wird');
