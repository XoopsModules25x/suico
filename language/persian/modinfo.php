...
define(
    ...
    'Thumbnails width in pixels<br>This means your picture thumbnail will be<br>most of this size in width<br>All proportions are maintained'
);
define('_MI_YOGURT_THUMBH_TITLE', 'Thumb Height');
define(
    '_MI_YOGURT_THUMBH_DESC',
    'Thumbnails Height in pixels<br>This means your picture thumbnail will be<br>most of this size in height<br>All proportions are maintained'
);
define('_MI_YOGURT_RESIZEDW_TITLE', 'Resized picture width');
define(
    '_MI_YOGURT_RESIZEDW_DESC',
    'Resized picture width in pixels<br>This means your picture will be<br>most of this size in width<br>All proportions are maintained<br> The original picture if bigger than this size will <br>be resized, so it wont break your template'
);
define('_MI_YOGURT_RESIZEDH_TITLE', 'Resized picture height');
define(
    '_MI_YOGURT_RESIZEDH_DESC',
    'Resized picture height in pixels<br>This means your picture will be<br>most of this size in height<br>All proportions are maintained<br> The original picture if bigger than this size will <br>be resized, so it wont break your template design'
);
define('_MI_YOGURT_ORIGINALW_TITLE', 'Max original picture width');
define(
    '_MI_YOGURT_ORIGINALW_DESC',
    "Maximum original picture width in pixels<br>This means the user's original picture can't exceed <br>this size in height<br> else it won't be uploaded"
);
define('_MI_YOGURT_ORIGINALH_TITLE', 'Max original picture height');
define(
    '_MI_YOGURT_ORIGINALH_DESC',
    "Maximum original picture height in pixels<br>This means the user's original picture can't exceed <br>this size in height<br> else it won't be uploaded"
);
...
define(
    '_MI_YOGURT_LICENSE',
    'Yogurt by Marcello Brand�o is licensed under a Attribution-No Derivative Works 2.5 Brazil.'
);
