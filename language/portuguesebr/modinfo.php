...
define(
    ...
    'Largura dos Thumbnails em pixels.<br>Significa que sua foto terá no máximo a largura indicada. Todas as proporções serão mantidas.'
);
define('_MI_YOGURT_THUMBH_TITLE', 'Altura do Thumb');
define(
    '_MI_YOGURT_THUMBH_DESC',
    'Largura dos Thumbnails em pixels.<br>Significa que sua foto terá no máximo a altura indicada. Todas as proporções serão mantidas.'
);
define('_MI_YOGURT_RESIZEDW_TITLE', 'Largura da foto redefinida');
define(
    '_MI_YOGURT_RESIZEDW_DESC',
    'Largura da foto redefinida em pixels.<br>Significa que sua foto terá no máximo a largura indicada. Todas as proporções serão mantidas.<br> Se a foto original for maior que tamanho indicado ela será redefinida para não quebrar o laytout do seu template.'
);
define('_MI_YOGURT_RESIZEDH_TITLE', 'Altura da foto redefinida');
define(
    '_MI_YOGURT_RESIZEDH_DESC',
    'Altura da foto redefinida em pixels.<br>Significa que sua foto terá no máximo a altura indicada. Todas as proporções serão mantidas.<br> Se a foto original for maior que tamanho indicado ela será redefinida para não quebrar o laytout do seu template.'
);
define('_MI_YOGURT_ORIGINALW_TITLE', 'Largura máxima da foto original');
define(
    '_MI_YOGURT_ORIGINALW_DESC',
    'Largura máxima medida em pixels.<br>Significa que a foto original do usuário não pode exceder a largura indicada ou não será realizado o upload.'
);
define('_MI_YOGURT_ORIGINALH_TITLE', 'Altura máxima da foto original');
define(
    '_MI_YOGURT_ORIGINALH_DESC',
    'Altura máxima medida em pixels.<br>Significa que a foto original do usuário não pode exceder a altura indicada ou não será realizado o upload.'
);
define('_MI_YOGURT_PATHUPLOAD_TITLE', 'Local dos Uploads');
define(
    '_MI_YOGURT_PATHUPLOAD_DESC',
    'Endereço real para o diretório que receberá as fotos.<br>No linux deverá ser (ex.):  /var/www/uploads<br>No windows deverá ser (ex.): C:/Program Files/www'
);
define('_MI_YOGURT_LINKPATHUPLOAD_TITLE', 'Link para o diretótio que receberá as fotos');
define(
    '_MI_YOGURT_LINKPATHUPLOAD_DESC',
    'Indicar o endereço do diretório que receberá as fotos dos usuário, exemplo: http://www.yoursite.com/uploads'
);
define('_MI_YOGURT_MAXFILEBYTES_TITLE', 'Tamanho máximo em bytes');
define(
    '_MI_YOGURT_MAXFILEBYTES_DESC',
    'Indicar o tamanho máximo que o arquivo da foto pode ter em bytes, exemplo: 512000 que significa 500 KB.'
);
...
define(
    ...
    'Ajuste o número de amigos exibidos por a página<br>Em minha página de amigos'
);
...
define(
    '_MI_YOGURT_MODULEDESC',
    'Este módulo permitirá que cada membro tenha um álbum de retrato com um número X de arquivos.'
);
...
define(
    ...
    'Template Para a parte superior do navbar utilizado em todas as páginas'
); //GibaPhp
...
define(
    '_MI_YOGURT_VIDEO_NEWVIDEO_NOTIFYCAP',
    'Avise-me quando um novo vídeo for enviado por este usuário'
); //GibaPhp
define(
    '_MI_YOGURT_VIDEO_NEWVIDEO_NOTIFYDSC',
    'Aviso - Descrição de Novo vídeo'
); //GibaPhp - dúvida aqui...
define(
    '_MI_YOGURT_VIDEO_NEWVIDEO_NOTIFYSBJ',
    '{X_OWNER_NAME} Apresentou um novo vídeo no seu perfil'
); //GibaPhp
...
define(
    ...
    'Avise-me quando um novo Note for enviado para este Notebook'
); //GibaPhp
define('_MI_YOGURT_NOTE_NEWNOTE_NOTIFYDSC', 'Aviso - Descrição do Novo Note'); //GibaPhp - dúvida aqui...
define(
    '_MI_YOGURT_NOTE_NEWNOTE_NOTIFYSBJ',
    '{X_OWNER_NAME} Apresentou um novo Note dentro do seu Notebook'
); //GibaPhp

define('_MI_YOGURT_MAINTUBEW_TITLE', 'Largura do vídeo Principal'); //GibaPhp
define(
    '_MI_YOGURT_MAINTUBEW_DESC',
    'Largura do vídeo que será mostrado na primeira página do módulo'
); //GibaPhp
define('_MI_YOGURT_MAINTUBEH_TITLE', 'Altura do vídeo Principal'); //GibaPhp
define(
    '_MI_YOGURT_MAINTUBEH_DESC',
    'Altura do vídeo que será mostrado na primeira página do módulo'
); //GibaPhp
...
define(
    '_MI_YOGURT_LICENSE',
    'Yogurt foi feito por Marcello Brandão é está sob uma Licença ( confirmar o correto desta licença) Não Atribuida de Obras Derivadas 2,5 Brasil.'
); //GibaPhp - Dúvida aqui... Também não entendi nem a tradução que eu fiz, rss :-)
...
define(
    '_MI_YOGURT_PICTURE_TEMPLATESEARCHRESULTDESC',
    'Este Template mostra os resultados de uma pesquisa de comunidades'
); //GibaPhp
...
define(
    '_MI_YOGURT_PICTURE_TEMPLATESEARCHRESULTSDESC',
    'Template para o resultado da Procura de Membros'
); //GibaPhp
...
define(
    ...
    'Ativando a seção de fotos para os usuários, permitirá que exista uma galeria de imagens para cada usuário'
); //GibaPhp
define('_MI_YOGURT_ENABLEFRIENDS_TITLE', 'Ativar a seção de amigos'); //GibaPhp
define(
    '_MI_YOGURT_ENABLEFRIENDS_DESC',
    'Ativando a seção de amigos para os usuários, permitirá o agendamento de amigos'
); //GibaPhp
define('_MI_YOGURT_ENABLEVIDEOS_TITLE', 'Ativando a seção de vídeos'); //GibaPhp
define(
    '_MI_YOGURT_ENABLEVIDEOS_DESC',
    'Ativando a seção de vídeos para os usuários, permitirá que exista uma galera de vídeos para cada usuário'
); //GibaPhp
define('_MI_YOGURT_ENABLENOTES_TITLE', 'Ativar a seção de Notes'); //GibaPhp
define(
    '_MI_YOGURT_ENABLENOTES_DESC',
    'Ativando a seção de Notes, permitirá que os membros possam deixar mensagens públicas no Note de outros usuários. Esse recurso é como você conhece no Facebook'
); //GibaPhp
define('_MI_YOGURT_ENABLEGROUPS_TITLE', 'Ativar a seção de Tribos'); //GibaPhp
define(
    '_MI_YOGURT_ENABLEGROUPS_DESC',
    'Ativando a seão de Tribos para os usuários, permitirá a criação de tribos. Desta forma alguns grupos de usuários irão se reunir em locais semelhantes de interesse'
); //GibaPhp
define('_MI_YOGURT_NOTESPERPAGE_TITLE', 'Número de Notes por página'); //GibaPhp
define(
    '_MI_YOGURT_NOTESPERPAGE_DESC',
    'Número de Notes em uma página antes de mostrar a navegação e paginação '
); //GibaPhp
...
define(
    '_MI_YOGURT_FRIEND_NEWPETITION_NOTIFYCAP',
    'Avise-me quando alguém pedir para ser seu amigo'
); //GibaPhp
...
define(
    ...
    'A ativação desta seção para os utilizadores, irá permitir a reprodução de áudio'
); //GibaPhp
