<form action="fieldslist.php" method="post" id="fieldform">
    <table>
        <th><{$smarty.const._AM_SUICO_NAME}></th>
        <th><{$smarty.const._AM_SUICO_TITLE}></th>
        <th><{$smarty.const._AM_SUICO_DESCRIPTION}></th>
        <th><{$smarty.const._AM_SUICO_TYPE}></th>
        <th><{$smarty.const._AM_SUICO_CATEGORY}></th>
        <th><{$smarty.const._AM_SUICO_WEIGHT}></th>
        <th><{$smarty.const._AM_SUICO_REQUIRED}></th>
                    ...
                    <td align="center">
                        <{if $field.canEdit}>
                            <a href="fieldslist.php?op=toggle&amp;field_required=<{$field.field_required}>&amp;field_id=<{$field.field_id}>"><img
                                        src="<{xoModuleIcons16}><{$field.field_required}>.png" title="<{$smarty.const._AM_SUICO_REQUIRED_TOGGLE}>"
                                        alt="<{$smarty.const._AM_SUICO_REQUIRED_TOGGLE}>"></a>
                        <{/if}>
                    </td>
                    <td align="center">
                        <{if $field.canEdit}>
