                                ...
                                <{section name=i loop=$mygroups}>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="group.php?group_id=<{$mygroups[i].group_id}>"><img src="<{$xoops_upload_url}>/suico/groups/<{$mygroups[i].img}>" alt="<{$mygroups[i].title}>" title="<{$mygroups[i].title}>" class="float-left pr-2" width="120" height="120"></a>
                                    ...
                                    <{section name=j loop=$groups}>
                                        <tr>
                                            <td>
                                                ...
                                                <a href="group.php?group_id=<{$groups[j].id}>"><img src="<{$xoops_upload_url}>/suico/groups/<{$groups[j].img}>" alt="<{$groups[j].title}>" title="<{$groups[j].title}>" class="float-left pr-2" width="120" height="120"></a>
                                                <h6>
