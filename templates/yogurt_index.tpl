                ...
                <div class="col-md-12">
                    <div id="content" class="content content-full-width">
                        ...
                        <{if $allow_profile_general==1}>
                            <div>
                                ...
                                <p><span class="yogurt-profileinfo-label"><{$lang_realname}>:</span><span class="yogurt-profileinfo-value"><{$user_realname}></span><br>
                                    <{/if}>
                                    <{if $user_location}>
                                        <span class="yogurt-profileinfo-label"><{$lang_location}>:</span>
                                        <span class="yogurt-profileinfo-value"><{$user_location}></span>
                                        <br>
                                    <{/if}>
                                    <{if $user_occupation}>
                                        <span class="yogurt-profileinfo-label"><{$lang_occupation}>:</span>
                                        <span class="yogurt-profileinfo-value"><{$user_occupation}></span>
                                        <br>
                                    <{/if}>
                                    <{if $user_interest}>
                                        <span class="yogurt-profileinfo-label"><{$lang_interest}>:</span>
                                        <span class="yogurt-profileinfo-value"><{$user_interest}></span>
                                        <br>
                                    <{/if}>
                                    <{if $user_extrainfo}>
                                        <span class="yogurt-profileinfo-label"><{$lang_extrainfo}>:</span>
                                        <br>
                                        <{$user_extrainfo}>
                                        <br>
                                    <{/if}>
                                    <{if $user_signature}>
                                        <span class="yogurt-profileinfo-label"><{$lang_signature}>:</span>
                                        <br>
                                        <{$user_signature}>
                                        <br>
                                    <{/if}>
                        ...
                        <{if $allow_profile_stats}>
                            ...
                            <span class="yogurt-profileinfo-label"><{$lang_membersince}>:</span>
                            <span class="yogurt-profileinfo-value"><{$user_joindate}></span>
                            <br>
                            <span class="yogurt-profileinfo-label"><{$lang_rank}>:</span>
                            <span class="yogurt-profileinfo-value"><{$user_rankimage}>  <{$user_ranktitle}></span>
                            <br>
                            <span class="yogurt-profileinfo-label"><{$lang_posts}>:</span>
                            <span class="yogurt-profileinfo-value"><{$user_posts}></span>
                            <br>
                            <span class="yogurt-profileinfo-label"><{$lang_lastlogin}>:</span>
                            <span class="yogurt-profileinfo-value"><{$user_lastlogin}></span>
                            <br>
