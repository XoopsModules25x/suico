...
<p id="breadcrumbs">
    ...
    <ul class="tabs-nav">
        ...
        <{/if}>
         ...
         <{ if $allow_videos !=-1 }><li <{ if $allow_videos ==0 }>class="tabs-disabled"<{/if}> <{if $section_name==$lang_videos}>class="tabs-selected" <{/if}>><a href="video.php?uid=<{$uid_owner}>"><span><img class="yogurt-nav-bar-icon" src="assets/images/video.gif" ><{$lang_videos}> ( <{$nb_videos}> )</span></a> </li><{/if}>
         <{ if $allow_friends !=-1 }><li <{ if $allow_friends ==0 }>class="tabs-disabled"<{/if}><{if $section_name==$lang_friends}>class="tabs-selected" <{/if}>> <a href="friends.php?uid=<{$uid_owner}>"><span><img class="yogurt-nav-bar-icon" src="assets/images/people.gif" ><{$lang_friends}> ( <{$nb_friends}> )</span></a> </li><{/if}>
         <{ if $allow_tribes !=-1 }><li <{ if $allow_tribes ==0 }>class="tabs-disabled"<{/if}><{if $section_name==$lang_tribes}>class="tabs-selected" <{/if}>> <a href="tribes.php?uid=<{$uid_owner}>"><span><img class="yogurt-nav-bar-icon" src="assets/images/tribes.gif" ><{$lang_tribes}> ( <{$nb_tribes}> )</span></a> </li><{/if}>
