                    ...
                    <div id="content" class="content content-full-width">
                            ...
                            <div class="alert alert-primary">
                                <form name="formNoteNew" id="formNoteNew" action="submitNote.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="text"><{$smarty.const._MD_YOGURT_SENDNOTESTO}> <{$owner_uname}></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"><{$smarty.const._MD_YOGURT_RECENTNOTES}></h4>
                                        <h6 class="card-subtitle"><{$smarty.const._MD_YOGURT_LATESTNOTES}></h6>
                                    </div>
