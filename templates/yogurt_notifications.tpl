...
<table class="outer">
  ...
  <tr>
    ...
    <td class="head"><input name="allbox" id="allbox" type="checkbox" value="<{$lang_checkall}>" /></td>
  ...
  <tr>
    ...
    <input type="checkbox" class="yogurt-notification-checkbox" id="not_list[]" name="not_list[<{$index}>][status]" value="1" <{if $event.subscribed}>checked="checked"<{/if}> />
    </td>
