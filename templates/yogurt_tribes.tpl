...
<script type='text/javascript'>
    <!--//
    function xoopsFormValidate_form_tribe() {
        myform = window.document.form_tribe;
        if (myform.tribe_img.value == "") {
            window.alert("Please enter Tribe Image");
            myform.tribe_img.focus();
            return false;
        }
        return true;
    }
